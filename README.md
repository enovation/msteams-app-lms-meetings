...
Edits are applied instantly via hot module reloading.
...
Serves the production build from the `build` folder locally, so you can sanity-check it before deploying.

## Learn More
This app is built with [Vite](https://vite.dev/guide/). You can learn more in the [Vite documentation](https://vite.dev/guide/).
